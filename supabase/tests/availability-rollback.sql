...
begin
  ...
  insert into public.listings(id,host_id,title,location,space_type,hourly_price,min_hours,capacity,timezone,images,latitude,longitude,status)
  values(yard,host,'QA availability yard','Test city','Backyards',20,2,5,'America/Los_Angeles',array['https://example.com/test.jpg'],34,-118,'published'),
    (draft,host,'QA availability draft','Test city','Backyards',20,2,5,'America/Los_Angeles','{}',null,null,'draft');
