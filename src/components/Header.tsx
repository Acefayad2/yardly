...
export default function Header() {
  ...
  const categories = [
    { label: "All", icon: "🌎", href: "/#discover" },
    { label: "Backyards", icon: "🏡", href: "/?q=Backyards#discover" },
    { label: "Pools", icon: "💧", href: "/?q=Pools#discover" },
    { label: "Events", icon: "🎉", href: "/?q=Event%20yards#discover" },
  ];
